// ─────────────────────────────────────────────────────────────
//  Hành tinh SADO. Mỗi chuyến đi = 1 thư mục src/trips/<id>/ (gói JS riêng,
//  chỉ tải khi mở đảo đó). Ảnh gốc: images/<id>/ → `npm run photos` sinh
//  public/photos/<id>/*.webp + src/trips/<id>/photo-meta.json.
//  Đăng ký đảo trong src/trips/index.js. Xem README / docs/island-playbook.md.
// ─────────────────────────────────────────────────────────────
//
